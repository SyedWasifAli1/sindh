...
const RegisteredFacilities = () => {
  const [facilities] = useState<Facility[]>([
    { name: "ABC Hospital", city: "Karachi", status: "Registered", date: "2023-10-01" },
    { name: "XYZ Clinic", city: "Hyderabad", status: "Registered", date: "2023-09-25" },
    { name: "PQR Diagnostic Center", city: "Sukkur", status: "Registered", date: "2023-09-20" },
    { name: "LMN Pharmacy", city: "Larkana", status: "Registered", date: "2023-09-15" },
    { name: "EFG Lab", city: "Mirpur Khas", status: "Registered", date: "2023-09-10" },
    { name: "RST Medical Center", city: "Karachi", status: "Registered", date: "2023-09-05" },
  ]);
